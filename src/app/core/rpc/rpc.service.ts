...
/**
 * The RPC service that maintains a single connection to the falcond daemon.
 *
...
export class RpcService implements OnDestroy {
   ...
   */
  private hostname: String = environment.falconHost;

  /**
   * Port number of default daemon
   */
  private port: number = environment.falconPort;
  ...
  /**
   * The call method will perform a single call to the falcond daemon and perform a callback to
